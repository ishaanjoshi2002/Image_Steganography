...
public class Image_encryption_Steganography {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Image_encryption_Steganography window = new Image_encryption_Steganography();
	 ...
	 */
	public Image_encryption_Steganography() {
		initialize();
	}
	...
	private void initialize() {
		...
		frmImageSteganography.setBounds(100, 100, 502, 238);
